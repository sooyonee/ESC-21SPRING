...
kappa1=kappa0+n
nu1=nu0+n
mu1=(kappa0*mu0+n*xbar)
s21=(1/nu1)*(nu0*s20+(n-1)*s20+(n-1)*s2+(kappa0*n/kappa1)*(xbar-mu0)^2)
dsinvchi=function(theta,v,tau2)
  ((v*tau2)^(v/2))/gamma(v/2)*(1/theta)^(v/2+1)*exp(-v*tau2/(2*theta))
